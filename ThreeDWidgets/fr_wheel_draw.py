...
def draw_Text_Wheel(vec=App.Vector(0.0,0.0,0.0), _color=FR_COLOR.FR_WHITE,  
                    setupRotation=[0,0,0,0],_rotation=([0.0,0.0,1.0,0.0]), LineWidth=1.0):
    try:
        TextScale=0.04
        ...
        txtXTransform.translation.setValue(6.0,.0,0.0)
        txtXTransform.rotation.setValue(coin.SbVec3f(6.0,0.0, 0.0),math.radians(00.0))
        ...
        txtXPTransform.translation.setValue(0.0,-6.0,0.0)
        ...
        txtYTransform.translation.setValue(0.0,6.0,0.0)
        ...
        tRadiusX.setValue(setupRotation[0], 0, 0) 
        tRadiusY.setValue(0, setupRotation[1],0) 
        tRadiusX.setValue(0,0, setupRotation[2]) 
        transfromX.rotation.setValue(tRadiusY,math.radians(setupRotation[3]))
        transfromY.rotation.setValue(tRadiusY,math.radians(setupRotation[3]))
        transfromZ.rotation.setValue(tRadiusY,math.radians(setupRotation[3]))
...
def draw_AllParts(vec=App.Vector(0,0,0),Ptype:str="",         
    ...
    try:
        ...
        tRadiusX.setValue(setupRotation[0], 0, 0) 
        tRadiusY.setValue(0, setupRotation[1],0) 
        tRadiusZ.setValue(0,0, setupRotation[2]) 

        tempTransform_x=coin.SoTransform()
        tempTransform_y=coin.SoTransform()
        tempTransform_z=coin.SoTransform()

        tempTransform_x.rotation.setValue(tRadiusX,math.radians(setupRotation[3]))
        tempTransform_y.rotation.setValue(tRadiusY,math.radians(setupRotation[3]))
        tempTransform_z.rotation.setValue(tRadiusZ,math.radians(setupRotation[3]))
