...
The FreeCAD 3D visualization basically works like this:
    ...
    Hence in this step, everything that's in the scene graph is put onto the render area
...
This means for your idea you have 2 options: First to add everything you need to the scenegraph,
 and use coin to achieve your functionality. Or second, use OpenGL to draw everything on top afterwards.
