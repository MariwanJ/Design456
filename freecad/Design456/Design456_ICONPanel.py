...
COMMANDS_Basic=[
    ...
    ["Design456_Pumpkin", Design456Init.ICON_PATH + 'Pumpkin.svg'],
    ["Design456_Fence", Design456Init.ICON_PATH + 'Fence.svg'],
...
class PrimitivePartsIconList:
    ...
    def setupUi(self):
        ...
        self.scrollArea.setGeometry(QtCore.QRect(20,80, 365, 420))
