...
"""					   "Design456_Tweak"              """
		...
		self.appendToolbar("Design456_Pyramid",Design456_Pyramid.list)
		...
		self.appendMenu("Design456_Pyramid",Design456_Pyramid.list)
	...
	def Deactivated(self):
		try:
			...
			FreeCAD.Console.PrintLog("Design456/Draft workbench deactivated.\n")
			return
		except Exception as exc:
			FreeCAD.Console.PrintError(exc)
	...
	def ContextMenu(self, recipient):
		...
		try:
			...
			self.appendContextMenu("Design456_Pyramid",Design456_Pyramid.list)
			#from DRAFT 
